...
def test_fitness_ordering():
    ...
    strong = CandidateMetrics(sharpe=1.5, sortino=2.0, profit_factor=2.0, payout=90.0, max_drawdown=5.0)
    weak = CandidateMetrics(sharpe=0.2, sortino=0.5, profit_factor=1.1, payout=82.0, max_drawdown=20.0)
